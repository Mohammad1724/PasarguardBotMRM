...
SETTINGS_MENU_SECTIONS = (
    ...
    SettingsMenuSection(
        ...
        (
            ...
            SettingsMenuItem("دکمه زرین‌پال", "zarinpal_mode"),
            SettingsMenuItem("دکمه ستاره‌ای", "stars_mode"),
            SettingsMenuItem("زیرمجموعه‌گیری", "referral_enabled", wide=True),
        ),
        columns=2,
    ),
    SettingsMenuSection(
    ...
    SettingsMenuSection(
        ...
        (
            ...
            SettingsMenuItem("کد هدیه", "gift_mode", wide=True),
        ),
        columns=2,
    ),
    SettingsMenuSection(
