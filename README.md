...
### داشبورد مشتری و مدیریت موجودی

[راهنمای مینی‌اپ مشتری و اصلاح موجودی توسط مالک](CUSTOMER_MINIAPP.fa.md) — مشاهده خصوصی موجودی و سرویس‌ها با `/miniapp`، بدون دسترسی به مدیریت و با همان دامنه و پورت HTTPS قبلی.

### ایمنی نصب و آپدیت — مرحله اول

[راهنمای مدیر 1.2.20 و برنامه 1.3.7](HARDENING_PHASE1.fa.md): توقف امن روی دیتادایر ناشناخته، phpMyAdmin محلی، Restart/Restore با همان ایمیج‌های موجود، بررسی آمادگی و اجرای Native بدون sync زمان شروع. پیش از ارتقا، محدودیت آپدیت غیراتمی Native و ترتیب به‌روزرسانی مدیر/برنامه را بخوانید.
